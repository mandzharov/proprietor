...
SECRET_KEY = os.getenv('SECRET_KEY', 'de6a_neg0vata#m@ma')
...
WSGI_APPLICATION = 'proprietor.wsgi.application'
...
DATABASES = {
    'default': PROD_DATABASE_CONFIG if APP_ENVIRONMENT == 'PROD' else DEV_DATABASE_CONFIG,
}
