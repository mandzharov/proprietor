...
class ReportViewTest(TestCase):
    def setUp(self):
        ...
        self.expense_type_water = UtilityType.objects.create(name='Water', description='')
        self.expense_type_water.save()
        self.expense_type_electricity = UtilityType.objects.create(name='Electricity', description='')
        self.expense_type_electricity.save()
        self.expense_type_heating = UtilityType.objects.create(name='Heating', description='')
    ...
    def test_report_avg_calc(self):
        ...
        response = self.client.get(reverse('report', kwargs={'apt_pk': self.apartment_1.pk}))
        self.assertEqual(200, response.status_code)
    ...
    def test_view_not_own_report_403(self):
        ...
        response = self.client.get(reverse('report', kwargs={'apt_pk': self.apartment_2.pk}))
        self.assertEqual(403, response.status_code)
