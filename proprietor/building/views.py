...
from proprietor.building.models import Apartment, Building, UtilitiesExpenses, UtilityType
...
class ListUtilityExpensesView(LoginRequiredMixin, PermissionRequiredMixin, helpers.UtilityExpenseListViewMixin,
                              gen_views.ListView):
...
class AddUtilityExpenseView(LoginRequiredMixin, PermissionRequiredMixin, helpers.UtilityExpenseCreateViewMixin,
...
class EditUtilityExpenseView(LoginRequiredMixin, PermissionRequiredMixin, helpers.UtilityExpenseEditViewMixin,
...
class DeleteUtilityExpenseView(LoginRequiredMixin, PermissionRequiredMixin, helpers.UtilityExpenseDeleteViewMixin,
...
class AddApartmentView(LoginRequiredMixin, PermissionRequiredMixin, gen_views.CreateView):
    model = Apartment
